...
int main() {
    ...
    std::vector<double> const xcp{0.587, 2.331, 2.154, 1.271, 0.331, −0.550, −1.437, −1.997, −2.690};
    std::vector<double> const ycp{6574, 19591, 32608, 45625, 58641, 71658, 84675, 97692, 110709};
