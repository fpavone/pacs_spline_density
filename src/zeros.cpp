...
void
BM(std::vector<double> & numbers, const Eigen::Block<Eigen::Map<Eigen::Matrix<double, -1, -1>, 0, Eigen::Stride<0, 0> >, 1, -1, false> & data)
{
  std::cout << "DATA TYPE" << type_name<decltype(data)>() << std::endl;
  double s = data.size();
