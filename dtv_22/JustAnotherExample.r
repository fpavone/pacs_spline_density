...
mmidx <- h1$mids
mmidy <- matrix(c(h1$density, h1$density),nrow=2, ncol = 15)
knots <- 7 # or as an alternative,  seq(midx[1], midx[12], length = 7)
ssol <- smoothSplines(k,l,alpha, mmidy,mmidx,knots)
plot(ssol)
